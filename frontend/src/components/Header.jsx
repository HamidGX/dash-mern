		...
		<>
			<div className='shadow-md w-full fixed z-[6666] top-0 left-0 '>
				<div className='md:flex items-center justify-between bg-white py-5 md:px-10 px-4 border-b-2 md:border-none'>
					...
					<ul
						className={`shadow md:shadow-none md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 p-4 transition-all duration-200 ease-in ${
